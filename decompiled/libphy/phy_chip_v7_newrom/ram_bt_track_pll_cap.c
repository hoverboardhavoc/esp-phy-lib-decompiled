 ...
 * Source: libphy -> phy_chip_v7_newrom.o -> ram_bt_track_pll_cap
 *
...

{
  ...
  if (DAT_000120a1 != '\0') {
    rom_bt_track_tx_power(1,DAT_0001209f);
  }
                    /* WARNING: Could not recover jumptable at 0x000119da. Too many branches */
