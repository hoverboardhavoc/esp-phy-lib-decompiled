...
/* WARNING: Removing unreachable block (ram,0x00011918) */
/* WARNING: Removing unreachable block (ram,0x0001191e) */
/* WARNING: Removing unreachable block (ram,0x00011928) */
...

{
  ...
  if (((iVar3 <= iVar2) &&
      (iVar2 = (**(code **)(_g_phyFuns + 0x168))
                         ((int)_DAT_00012096,iVar1,*(code **)(_g_phyFuns + 0x168)), param_1 != 0))
     && (DAT_000121fe != iVar2)) {
