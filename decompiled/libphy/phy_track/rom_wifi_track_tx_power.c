 ...
 * Source: libphy -> phy_track.o -> rom_wifi_track_tx_power
 *
...
/* WARNING: Removing unreachable block (ram,0x0001018a) */
/* WARNING: Removing unreachable block (ram,0x00010194) */
/* WARNING: Removing unreachable block (ram,0x00010184) */
/* WARNING: Removing unreachable block (ram,0x000100d8) */
/* WARNING: Removing unreachable block (ram,0x0001013a) */
...

{
  ...
  if (DAT_00011208 == '\x01') {
    iVar3 = (int)_DAT_00011210;
  }
  else {
    iVar3 = (int)_DAT_00011214;
  }
  iVar4 = 2;
  ...
  sVar1 = (**(code **)(_g_phyFuns + 0x28))
                    ((int)_DAT_00011096,(int)_DAT_000110b4,(int)_DAT_000110b2,
  ...
  if (iVar2 < iVar4) {
    ...
    iVar2 = ram_temp_to_power((int)sVar1,iVar3,0);
  }
  if ((param_1 != 0) && (DAT_000111ff != iVar2)) {
    rom_phy_bbpll_cal(1);
