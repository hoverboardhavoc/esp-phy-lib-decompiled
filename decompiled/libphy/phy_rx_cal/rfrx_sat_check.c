...

{
  ...
  uVar6 = (**(code **)(_g_phyFuns + 0x1b8))(0x6b,0,7,3,0,*(code **)(_g_phyFuns + 0x1b8));
  uVar7 = (**(code **)(_g_phyFuns + 0x1b8))(0x6b,0,7,7,4,*(code **)(_g_phyFuns + 0x1b8));
  uVar8 = (**(code **)(_g_phyFuns + 0x1b8))(0x6b,0,8,3,0,*(code **)(_g_phyFuns + 0x1b8));
  uVar9 = (**(code **)(_g_phyFuns + 0x1b8))(0x6b,0,3,3,0,*(code **)(_g_phyFuns + 0x1b8));
  uVar10 = (**(code **)(_g_phyFuns + 0x1b8))(0x6b,0,5,3,0,*(code **)(_g_phyFuns + 0x1b8));
  (**(code **)(_g_phyFuns + 0x1bc))(0x6b,0,7,3,0,0,*(code **)(_g_phyFuns + 0x1bc));
  (**(code **)(_g_phyFuns + 0x1bc))(0x6b,0,7,7,4,0,*(code **)(_g_phyFuns + 0x1bc));
  (**(code **)(_g_phyFuns + 0x1bc))(0x6b,0,8,3,0,0,*(code **)(_g_phyFuns + 0x1bc));
  (**(code **)(_g_phyFuns + 0x1bc))(0x6b,0,3,3,0,0,*(code **)(_g_phyFuns + 0x1bc));
  (**(code **)(_g_phyFuns + 0x1bc))(0x6b,0,5,3,0,0,*(code **)(_g_phyFuns + 0x1bc));
  iVar15 = 0;
  uVar3 = 0x50;
  ...
  (**(code **)(_g_phyFuns + 0x1cc))(1,1,0x1f9,*(code **)(_g_phyFuns + 0x1cc));
  pbus_rx_dco_cal(4000,auStack_54,10,0,0);
  (**(code **)(_g_phyFuns + 0x1bc))(100,1,8,2,0,0,*(code **)(_g_phyFuns + 0x1bc));
  do {
    start_tx_tone_step(1,0x40,uVar3 & 0xff,0,0,0);
    (**(code **)(_g_phyFuns + 0x10c))(1,0x400,&uStack_4c,*(code **)(_g_phyFuns + 0x10c));
    if (param_1 != 0) {
...
_L237:
  ...
  (**(code **)(_g_phyFuns + 0x1bc))(0x6b,0,7,3,0,uVar6,*(code **)(_g_phyFuns + 0x1bc));
  (**(code **)(_g_phyFuns + 0x1bc))(0x6b,0,7,7,4,uVar7,*(code **)(_g_phyFuns + 0x1bc));
  (**(code **)(_g_phyFuns + 0x1bc))(0x6b,0,8,3,0,uVar8,*(code **)(_g_phyFuns + 0x1bc));
  (**(code **)(_g_phyFuns + 0x1bc))(0x6b,0,3,3,0,uVar9,*(code **)(_g_phyFuns + 0x1bc));
  (**(code **)(_g_phyFuns + 0x1bc))(0x6b,0,5,3,0,uVar10,*(code **)(_g_phyFuns + 0x1bc));
  return;
}
