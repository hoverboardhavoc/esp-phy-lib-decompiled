...

{
  ...
  uVar13 = 0;
  if (param_1 != 0) {
    uVar13 = (**(code **)(_g_phyFuns + 0x1b8))(0x67,1,3,2,2,*(code **)(_g_phyFuns + 0x1b8));
...
_L166:
  ...
  (**(code **)(_g_phyFuns + 0x1c))(uVar1,0x104,iVar11,*(code **)(_g_phyFuns + 0x1c));
  if (param_1 != 0) {
    pcVar3 = *(code **)(_g_phyFuns + 0x1cc);
  ...
  do {
    ...
    if (param_4 != 0) {
      uVar7 = (**(code **)(_g_phyFuns + 0x1d0))(5,1,*(code **)(_g_phyFuns + 0x1d0));
      uVar8 = (**(code **)(_g_phyFuns + 0x1d0))(1,2,*(code **)(_g_phyFuns + 0x1d0));
  ...
  *(undefined2 *)(iVar10 * 2 + param_3) = uVar5;
  if (iVar10 != 0) {
    if (param_1 != 0) {
      (**(code **)(_g_phyFuns + 0x1bc))(0x67,1,3,2,2,uVar13,*(code **)(_g_phyFuns + 0x1bc));
    }
