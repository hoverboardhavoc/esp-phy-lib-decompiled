  ...
  do {
    ...
    *param_4 = (short)uVar9;
    ...
    if (param_2 == 0) {
      ...
      (**(code **)(_g_phyFuns + 0x1cc))(2,2,*param_6,*(code **)(_g_phyFuns + 0x1cc));
      (**(code **)(_g_phyFuns + 0x1cc))(3,2,param_6[1],*(code **)(_g_phyFuns + 0x1cc));
      ets_delay_us(10);
      rxdc_est_min(param_3,1,&iStack_58,&uStack_5a);
      (**(code **)(_g_phyFuns + 0x1cc))(1,2,0x20,*(code **)(_g_phyFuns + 0x1cc));
      (**(code **)(_g_phyFuns + 0x1cc))(2,2,param_6[2],*(code **)(_g_phyFuns + 0x1cc));
      (**(code **)(_g_phyFuns + 0x1cc))(3,2,param_6[3],*(code **)(_g_phyFuns + 0x1cc));
      ets_delay_us(10);
...
_L136:
      iVar6 = 1;
      if (param_5[1] < 1) {
        iVar6 = (int)((uint)(param_5[1] != 0) * -0x10000) >> 0x10;
      }
    }
    else {
...
_L135:
        iVar14 = 1;
        if (*param_5 < 1) {
          iVar14 = (int)((uint)(*param_5 != 0) * -0x10000) >> 0x10;
        }
      }
      if (iVar6 == 0) goto _L136;
    }
    if (param_2 == 2) {
