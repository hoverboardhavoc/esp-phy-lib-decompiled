 ...
 * Source: libphy -> phy_hw_freq.o -> get_rf_freq_init
 *
...

{
  ...
  if ((_DAT_00011124 & 0x20) == 0) {
    ram_write_pll_cap(200);
    set_rfpll_freq(DAT_000110f7,0x960,0,&bStack_44);
    iVar2 = read_pll_cap();
    iVar3 = (**(code **)(_g_phyFuns + 0x1b8))(0x62,1,6,3,0,*(code **)(_g_phyFuns + 0x1b8));
    set_rfpll_freq(DAT_000110f7,0x9a0,0,&bStack_44);
    sVar1 = read_pll_cap();
    ...
    uVar8 = 0;
    do {
      rfpll_set_freq(uVar8 + 0x960,DAT_000110f7,0,&bStack_44);
      iVar6 = iVar10 / 0x40;
      uVar5 = uVar8 & 0xff;
      uVar8 = uVar8 + 1;
      uStack_34 = 0;
    ...
    _DAT_000110e6 = 0;
    _DAT_00011124 = _DAT_00011124 | 0x20;
  }
  return;
}
