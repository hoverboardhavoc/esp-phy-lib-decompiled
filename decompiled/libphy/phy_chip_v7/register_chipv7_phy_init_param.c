...

{
  ...
  DAT_00012efa = *param_1;
  DAT_00012efb = param_1[1];
  puVar3 = param_1 + 2;
  puVar2 = &phy_param;
  do {
    uVar1 = *puVar3;
  ...
  DAT_00012f0c = param_1[0x10];
  if ((char)DAT_00012f0c < '\0') {
    power_cal_offset = DAT_00012f0c & 0x7f;
  }
  DAT_00012f0e = param_1[0x12];
  puVar3 = param_1 + 0x13;
  puVar2 = &phy_param;
  do {
    uVar1 = *puVar3;
  ...
  _DAT_00012f4c = CONCAT11(param_1[0x46],param_1[0x47]);
  DAT_00012f4e = param_1[0x48];
  _DAT_00012f50 = ((byte)param_1[0x49] & 0x7f) << 8 | (ushort)(byte)param_1[0x4a];
  DAT_00012f52 = param_1[0x4b];
  DAT_00012f53 = param_1[0x4c];
  return;
}
