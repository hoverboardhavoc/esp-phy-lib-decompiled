...

{
  ...
  *puVar5 = 0;
  ...
  uVar7 = iVar6 + 4;
  if (uVar7 < 9) {
    iVar9 = (int)(char)(&DAT_00012f58)[iVar6];
    iVar2 = (int)(char)(&DAT_00012f40)[iVar6];
    iVar4 = (int)(char)(&DAT_00012f4c)[iVar6];
    uVar10 = (uint)(char)(&DAT_00012f64)[iVar6];
    iVar3 = 3;
  }
  else {
    uVar10 = 0;
  ...
  *puVar5 = uVar10 | uVar10 << 0x14 | uVar10 << 10;
  if (uVar7 < 9) {
    iVar9 = (int)(char)(&DAT_00012f70)[iVar6];
    uVar10 = (uint)(char)(&DAT_00012f7c)[iVar6];
  }
  else {
    uVar10 = 0;
    iVar9 = 0;
  ...
  if (uVar7 < 9) {
    iVar9 = (int)(char)(&DAT_00012f94)[iVar6];
    iVar4 = (int)(char)(&DAT_00012f88)[iVar6];
    uVar10 = (uint)(char)(&DAT_00012fa0)[iVar6];
  }
  else {
    uVar10 = 0;
    iVar9 = 0;
  ...
  if (uVar7 < 9) {
    iVar9 = (int)(char)(&DAT_00012fb8)[iVar6];
    iVar4 = (int)(char)CSWTCH_121[iVar6 + 4];
    uVar10 = (uint)(char)(&DAT_00012fc4)[iVar6];
  }
  else {
    uVar10 = 0;
    iVar9 = 0;
  ...
  if (uVar7 < 9) {
    ...
    iVar4 = (int)(char)CSWTCH_121[iVar6 + 4];
    uVar7 = (uint)(char)(&DAT_00012fdc)[iVar6];
  }
  else {
    uVar7 = 0;
    iVar9 = 0;
