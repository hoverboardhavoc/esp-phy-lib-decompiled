...

{
  ...
  *puVar5 = 0;
  ...
  if (uVar7 < 9) {
    ...
    iVar2 = (int)(char)(&DAT_00012ff4)[iVar6];
  ...
  *puVar5 = uVar10 | uVar10 << 0x14 | uVar10 << 10;
  if (uVar7 < 9) {
    iVar9 = (int)(char)(&DAT_00013024)[iVar6];
    uVar10 = (uint)(char)(&DAT_00013030)[iVar6];
  }
  else {
    uVar10 = 0;
    iVar9 = 0;
  ...
  if (uVar7 < 9) {
    ...
    iVar4 = (int)(char)(&DAT_0001303c)[iVar6];
    uVar10 = (uint)(char)(&DAT_00013054)[iVar6];
  }
  else {
    uVar10 = 0;
    iVar9 = 0;
  ...
  if (uVar7 < 9) {
    iVar9 = (int)(char)(&DAT_0001306c)[iVar6];
    iVar4 = (int)(char)CSWTCH_127[iVar6 + 4];
    uVar10 = (uint)(char)(&DAT_00013078)[iVar6];
  }
  else {
    uVar10 = 0;
    iVar9 = 0;
  ...
  if (uVar7 < 9) {
    iVar9 = (int)(char)(&DAT_00013084)[iVar6];
    iVar4 = (int)(char)CSWTCH_127[iVar6 + 4];
    uVar7 = (uint)(char)(&DAT_00013090)[iVar6];
  }
  else {
    uVar7 = 0;
    iVar9 = 0;
