...
_L398:
      ...
      if (bVar1) {
_L391:
        if (iVar8 < 0x2c) goto _L380;
        if ((iVar8 != 0x2c) || (bVar1 = iVar5 < iVar9, 0x2b < iVar10)) {
          if (iVar5 < iVar9) goto _L398;
          goto _L384;
        }
        if (iVar5 < iVar9) goto _L377;
      }
      else {
        if (0x2c < iVar8) {
_L384:
...
_L380:
        if ((iVar8 <= iVar10) && (iVar8 == 0x2c)) goto _L384;
      }
      bVar1 = false;
    }
_L377:
    if (((iVar6 < 0x51) || (local_42 == 0x78)) || (iVar3 < 1)) goto _L384;
    iVar3 = 2;
    if (bVar1) {
