...

{
  ...
  if (param_1 == 0) {
    ...
    phy_printf("crc8_init:0x%x,0x%x\n",DAT_000110cf,(int)(char)uVar1);
    if (DAT_000110cf != uVar1) {
  ...
  phy_printf("v=%d,c=%d, p=%d,%d,%d,%d,%d,%d, %d,%d,%d,%d,%d,%d,%d,%d,fcc=%d freq=%d,%d,crc=%d\n",
             init_param_default,DAT_00011051,DAT_00011052,DAT_00011053,read_flash_init_para,
             DAT_00011055,DAT_00011056);
  return;
}
