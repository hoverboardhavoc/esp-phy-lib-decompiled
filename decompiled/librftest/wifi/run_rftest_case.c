                ...
                if (iVar2 == 0) {
                  *(uint *)*param_2 = ~param_2[1] & *(uint *)*param_2;
                  ...
                  if (iVar2 == 0) {
                    ...
                    if (iVar2 == 0) {
                      uVar3 = i2c_readReg((char)*param_2,(char)param_2[1],(char)param_2[2]);
                      phy_printf("0x%x\n",uVar3);
                    }
                    else {
                      iVar2 = strcmp(param_1,"wi");
                      if (iVar2 == 0) {
                        i2c_writeReg((char)*param_2,(char)param_2[1],(char)param_2[2],
                                     (char)param_2[3]);
                        phy_printf(&_LC49,param_1);
                      }
                      else {
                        ...
                        if (iVar2 == 0) {
                          i2c_writeReg_Mask((char)*param_2,(char)param_2[1],(char)param_2[2],
                                            (char)param_2[3],(char)param_2[4],(char)param_2[5]);
                          phy_printf(&_LC49,param_1);
                        }
                        else {
                          iVar2 = strcmp(param_1,"rim");
                          if (iVar2 == 0) {
                            uVar3 = i2c_readReg_Mask((char)*param_2,(char)param_2[1],
                                                     (char)param_2[2],(char)param_2[3],
                                                     (char)param_2[4]);
                            phy_printf("0x%x\n",uVar3);
                          }
                          else {
                            ...
                            if (iVar2 == 0) {
                              ...
                              if (iVar2 == 0) {
                                ...
                                if (iVar2 == 0) {
                                  ...
                                  if (iVar2 == 0) {
                                    uVar3 = pbus_rd((char)*param_2,(char)param_2[1]);
                                    phy_printf("0x%x\n",uVar3);
                                  }
                                  else {
                                    ...
                                    if (iVar2 == 0) {
                                      ...
                                      if (iVar2 == 0) {
                                        txtone_enable = *param_2 != 0 || param_2[3] != 0;
                                        start_tx_tone_step(*param_2 & 0xff,(int)(short)param_2[1],
                                                           (char)param_2[2],param_2[3] & 0xff,
                                        ...
                                        if (iVar2 == 0) {
                                          ...
                                          if (iVar2 == 0) {
                                            bt_adctrig(*param_2,param_2[1],param_2[2],param_2[3],
                                                       param_2[4],param_2[5],param_2[6],param_2[7]);
                                            phy_printf(&_LC49,param_1);
                                          }
                                          else {
                                            ...
                                            if (iVar2 == 0) {
                                              ...
                                              if (iVar2 == 0) {
                                                ...
                                                set_rxclk_en(1);
                                                set_txclk_en(1);
                                                pbus_rx_dco_cal(0x1000,&local_28,1);
                                                phy_printf("%d, %d, %d, %d\n",(int)(short)local_28,
                                                           (int)local_28._2_2_);
                                              }
                                              else {
                                                ...
                                                if (iVar2 == 0) {
                                                  ...
                                                  phy_printf("%s, freq=%d, freq_offset=%d\n",param_1
                                                             ,uVar6 & 0xffff,(int)(short)uVar5);
                                                }
                                                else {
                                                  iVar2 = strcmp(param_1,"RFChannelSel");
                                                  if (iVar2 == 0) {
                                                    iVar2 = phy_time_now();
                                                    ...
                                                    if (iVar2 == 0) {
                                                      chip_v7_set_chan((short)*param_2,
                                                                       (int)(char)param_2[1]);
                                                      phy_printf("%s %d %d\n",param_1,*param_2,
                                                                 param_2[1]);
                                                    }
                                                  ...
                                                  if (iVar2 == 0) {
                                                    ...
                                                    phy_printf("freq: %d %dkhz %d\n",*param_2,
                                                               (int)(short)uVar5,(int)_phy_param);
                                                  }
                                                  else {
                                                      ...
                                                      if (iVar2 == 0) {
                                                        ...
                                                        if (iVar2 == 0) {
                                                          ...
                                                          if (iVar2 == 0) {
                                                            ...
                                                            if (iVar2 == 0) {
                                                              test_txtone_pwr(*param_2,param_2[1],
                                                                              param_2[2],
                                                                              (int)(short)param_2[3]
                                                                             );
                                                              phy_printf(&_LC11);
                                                  ...
                                                  param_1,*param_2 & 0xff,phy_tx_pwr_print_en);
                                                  }
                                                  else {
                                                    ...
                                                    if (iVar2 != 0) {
                                                      ...
                                                      if (iVar2 == 0) {
                                                        _phy_param = CONCAT31(phy_param_1,
                                                                              (char)*param_2);
                                                        phy_printf("%s %d\n",param_1,*param_2);
                                                      }
                                                      else {
                                                  ...
                                                  if (iVar2 == 0) {
                                                    ...
                                                    iVar2 = strcmp(param_1,"set_freq_time");
                                                    if (iVar2 == 0) {
                                                      iVar2 = phy_time_now();
                                                      ...
                                                      iVar2 = strcmp(param_1,"test_i2c_time");
                                                      if (iVar2 == 0) {
                                                  ...
                                                  if (iVar2 == 0) {
                                                    ...
                                                    if (iVar2 == 0) {
                                                      uVar3 = get_sar2_vol((char)*param_2);
                                                      phy_printf(&_LC102,uVar3);
                                                    }
                                                    else {
                                                  ...
                                                  phy_printf(&_LC102,uVar3);
                                                    ...
                                                    iVar2 = strcmp(param_1,"phy_wakeup_init");
                                                    if (iVar2 == 0) {
                                                      iVar2 = phy_time_now();
                                                      phy_wakeup_init();
                                                      iVar4 = phy_time_now();
                                                        ...
                                                        if (iVar2 == 0) {
                                                          ...
                                                          if (iVar2 == 0) {
                                                            ...
                                                            if (iVar2 == 0) {
                                                              ...
                                                              iVar2 = strcmp(param_1,"regulator_slt"
                                                                            );
                                                              if ((iVar2 != 0) &&
                                                                 (iVar2 = strcmp(param_1,
                                                  "clk10m_enable"), iVar2 != 0)) {
                                                    ...
                                                    if (iVar2 != 0) {
                                                      ...
                                                      if (iVar2 == 0) {
                                                        ...
                                                        phy_printf(&_LC136,uVar3);
                                                        return 1;
                                                      }
                                                      iVar2 = strcmp(param_1,"dc_iq_est");
                                                      if (iVar2 == 0) {
                                                        dc_iq_est_test(1,(short)*param_2,&uStack_34,
                                                                       &local_28);
                                                        phy_printf("%d,%d,%d,%d,%d,%d,%s\n",
                                                                   uStack_34,uStack_30,uStack_2c,
                                                                   local_28,uStack_24,uStack_20,
                                                                   param_1);
                                                        return 1;
                                                      }
                                                      ...
                                                      if (iVar2 != 0) {
                                                        ...
                                                        if (iVar2 == 0) {
                                                          phy_printf("%s, %d 0x%x\n",param_1,
                                                                     *param_2,0x40820000);
                                                          phy_freq_mem_backup((char)*param_2,
                                                                              0x40820000);
                                                          return 1;
                                                        }
                                                        ...
                                                        if (iVar2 != 0) {
                                                          ...
                                                          if (iVar2 == 0) {
                                                            ...
                                                            uStack_34 = 0;
                                                            local_28 = 0;
                                                            le_master_test((char)*param_2,
                                                                           param_2[1] + 1 & 0xff,
                                                                           (char)param_2[2],
                                                                           (short)param_2[3],
                                                                           param_2[4],&uStack_48,
                                                                           &uStack_44,&uStack_40);
                                                            phy_printf("le_txrx_num: %d, %d, %d,",
                                                                       uStack_48,uStack_40,uStack_3c
                                                                      );
                                                            phy_printf(
                                                  "le_rssi: avg=%d, max=%d, min=%d\n",uStack_38,
                                                  uStack_34,local_28);
                                                  ...
                                                  if (iVar2 == 0) {
                                                    ...
                                                    uStack_34 = 0;
                                                    local_28 = 0;
                                                    zb_master_test(*param_2,param_2[1],param_2[2],
                                                                   param_2[3],(char)param_2[4],
                                                                   &uStack_48,&uStack_44,&uStack_40)
                                                    ;
                                                    phy_printf("zb_txrx_num: %d, %d, ",uStack_48,
                                                               uStack_40);
                                                    phy_printf("zb_rssi: avg=%d, max=%d, min=%d\n",
                                                               uStack_38,uStack_34,local_28);
                                                    phy_printf(
                                                  "%s chan=%d, pwr=%d, tx_num=%d, tx_len=%d, hw_ack_en=%d\n"
                                                  ...
                                                  if (iVar2 == 0) {
                                                    phy_printf(
                                                  "%s chan=%d, pwr=%d, tx_len=%d, hw_ack_en=%d\n",
                                                  param_1,*param_2,param_2[1],param_2[2],param_2[3])
                                                  ;
                                                  zb_slave_test(*param_2,param_2[1],param_2[2],
                                                                (char)param_2[3]);
                                                  return 1;
                                                  }
                                                  ...
                                                  iVar2 = strcmp(param_1,"get_internal_vol");
                                                  if (iVar2 == 0) {
                                                    get_inernal_vol(0x66,10,2,2,1,10,1,0);
                                                    phy_printf("%s %d,%d,%d,%d,%d\n",param_1,
                                                               *param_2,local_28 & 0xffff,
                                                               local_28 >> 0x10,uStack_24 & 0xffff,
                                                               uStack_24 >> 0x10);
                                                    return 1;
                                                  }
                                                  ...
                                                  *param_2,param_2[1],param_2[2]);
                                                  ...
                                                  if (iVar2 == 0) {
                                                    rxiq_get_pwr((char)*param_2,&local_28);
                                                  ...
                                                  iVar2 = strcmp(param_1,"cpu_update");
                                                  if (iVar2 == 0) {
                                                    ets_update_cpu_frequency(*param_2);
                                                    phy_printf("%s %d\n",param_1,*param_2);
                                                    return 1;
                                                  }
                                                  iVar2 = strcmp(param_1,"delay_us_test");
                                                  if (iVar2 == 0) {
                                                    iVar2 = phy_time_now();
                                                  ...
                                                  if (iVar2 == 0) {
                                                    force_iq_set((char)*param_2,(char)param_2[1],
                                                                 (int)(char)param_2[2],
                                                                 (int)(char)param_2[3]);
                                                  ...
                                                  iVar2 = strcmp(param_1,"pll_cap_update");
                                                  if (iVar2 == 0) {
                                                    pll_cap_mem_update((int)(short)*param_2);
                                                    phy_printf("%s,%d\n",param_1,*param_2);
                                                    return 1;
                                                  }
                                                  iVar2 = strcmp(param_1,"pll_dac_update");
                                                  if (iVar2 == 0) {
                                                    pll_dac_mem_update((char)*param_2);
                                                    phy_printf("%s,%d\n",param_1,*param_2);
                                                    return 1;
                                                  }
                                                  iVar2 = strcmp(param_1,"pll_mem_update");
                                                  if (iVar2 == 0) {
                                                  ...
                                                  iVar2 = strcmp(param_1,"ble_tone_start");
                                                  if (iVar2 == 0) {
                                                    set_rf_freq_offset(_phy_param & 0xff,
                                                                       (short)*param_2,0);
                                                  ...
                                                  iVar2 = strcmp(param_1,"ble_tone_stop");
                                                  if (iVar2 == 0) {
                                                    force_txon_mode(0,0);
                                                    phy_printf(&_LC49,param_1);
                                                    return 1;
                                                  }
                                                  iVar2 = strcmp(param_1,"esp_phy_rxiq_cal");
                                                  if (iVar2 == 0) {
                                                    if ((int)param_2[1] < 1) {
                                                      ate_rxiq_cal((short)*param_2,0,1);
                                                    }
                                                    else {
                                                      esp_phy_rxiq_cal(&local_28,0,1);
                                                    }
                                                    phy_printf("%s %d %d %d\n",param_1,*param_2,
                                                               param_2[1],param_2[2]);
                                                    return 1;
                                                  ...
                                                  if (iVar2 == 0) {
                                                    rxiq_cal_test(&local_28,1);
                                                    phy_printf(&_LC49,param_1);
                                                    return 1;
                                                  }
                                                  iVar2 = strcmp(param_1,"get_rxiq_remain");
                                                  if (iVar2 == 0) {
                                                    uVar3 = get_rxiq_remain();
                                                    phy_printf("%s %d\n",param_1,uVar3);
                                                    return 1;
                                                  }
                                                  iVar2 = strcmp(param_1,"get_rxiq_pwr");
                                                  if (iVar2 == 0) {
                                                    uVar3 = get_rxiq_pwr();
                                                    phy_printf("%s %d\n",param_1,uVar3);
                                                    return 1;
                                                  }
                                                  iVar2 = strcmp(param_1,"phy_freq_cal");
                                                  if (iVar2 == 0) {
                                                    esp_phy_freq_cal((short)*param_2,1);
                                                    phy_printf(&_LC49,param_1);
                                                    return 1;
                                                  }
                                                  iVar2 = strcmp(param_1,"freq_rx_cal_en");
                                                  if (iVar2 == 0) {
                                                    freq_rx_cal_en = (undefined1)*param_2;
                                                    phy_printf("%s %d %d %d\n",param_1,
                                                               *param_2 & 0xff,xtal_dreg_1p2,
                                                               DAT_00015225);
                                                    return 1;
                                                  }
                                                  iVar2 = strcmp(param_1,"xtal_freq_rx_cal");
                                                  if (iVar2 == 0) {
                                                    xtal_freq_rx_cal_init((short)*param_2,1);
                                                    phy_printf("%s %d\n",param_1,*param_2);
                                                    return 1;
                                                  }
                                                  iVar2 = strcmp(param_1,"esp_phy_rx_snr");
                                                  if (iVar2 == 0) {
                                                    esp_phy_rx_snr((short)*param_2,
                                                                   (int)(char)param_2[1],
                                                                   (int)(char)param_2[2]);
                                                    phy_printf("%s %d %d %d\n",param_1,*param_2,
                                                               param_2[1],param_2[2]);
                                                  ...
                                                  iVar2 = strcmp(param_1,"bb_cfo_cfg");
                                                  if (iVar2 == 0) {
                                                  ...
                                                  iVar2 = strcmp(param_1,"phy_mem_print");
                                                  if (iVar2 == 0) {
                                                    phy_mem_print();
                                                    phy_printf(&_LC49,param_1);
                                                    return 1;
                                                  }
                                                  iVar2 = strcmp(param_1,"phy_get_rf_freq_init");
                                                  if (iVar2 == 0) {
                                                    iVar2 = phy_time_now();
                                                  ...
                                                  if (iVar2 == 0) {
                                                    set_pbus_logain((char)*param_2,(char)param_2[1])
                                                    ;
                                                    phy_printf("%s %d %d\n",param_1,*param_2,
                                                               param_2[1]);
                                                    return 1;
                                                  }
                                                  iVar2 = strcmp(param_1,"get_tx_gain");
                                                  if (iVar2 != 0) {
                                                    return 0;
                                                  }
                                                  get_tx_gain_table((char)*param_2,&local_28);
                                                  phy_printf("%d,%d,%d,%d\n",local_28 & 0xff,
                                                             local_28 >> 8 & 0xff,
                                                             local_28 >> 0x10 & 0xff,*param_2);
                                                  return 1;
                                                  }
                                                  }
                                                  phy_printf("%s %d\n",param_1,*param_2);
