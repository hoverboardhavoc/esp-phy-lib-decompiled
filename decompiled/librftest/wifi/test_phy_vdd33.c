 ...
 * Source: librftest -> wifi.o -> test_phy_vdd33
 *
...
undefined4 test_phy_vdd33(undefined4 param_1)

{
  undefined4 uVar1;
  
  (**(code **)(_g_phyFuns + 0xfc))(*(code **)(_g_phyFuns + 0xfc));
  ...
  uVar1 = (**(code **)(_g_phyFuns + 0x150))(param_1,*(code **)(_g_phyFuns + 0x150));
