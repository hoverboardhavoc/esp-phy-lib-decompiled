 ...
 * Source: librftest -> phy_test.o -> set_dump_mode
 *
...
void set_dump_mode(int param_1)

{
  _DAT_600a0958 = _DAT_600a0958 & 0xfffffffc;
  _DAT_600a70b8 = _DAT_600a70b8 & 0xfffffff8;
  if (param_1 == 0) {
    _DAT_600a70b8 = _DAT_600a70b8 | 1;
  }
  return;
}
