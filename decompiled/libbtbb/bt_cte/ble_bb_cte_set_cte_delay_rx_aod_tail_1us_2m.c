 ...
 * Source: libbtbb -> bt_cte.o -> ble_bb_cte_set_cte_delay_rx_aod_tail_1us_2m
 *
...
void ble_bb_cte_set_cte_delay_rx_aod_tail_1us_2m(uint param_1)

{
  _DAT_600a2154 = _DAT_600a2154 & 0xffffff00 | param_1 & 0xff;
  return;
}
