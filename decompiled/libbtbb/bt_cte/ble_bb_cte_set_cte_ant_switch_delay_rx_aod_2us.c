 ...
 * Source: libbtbb -> bt_cte.o -> ble_bb_cte_set_cte_ant_switch_delay_rx_aod_2us
 *
...
void ble_bb_cte_set_cte_ant_switch_delay_rx_aod_2us(uint param_1)

{
  _DAT_600a212c = (param_1 & 0xff) << 0x10 | _DAT_600a212c & 0xff00ffff;
  return;
}
