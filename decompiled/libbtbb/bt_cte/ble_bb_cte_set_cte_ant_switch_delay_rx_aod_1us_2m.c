 ...
 * Source: libbtbb -> bt_cte.o -> ble_bb_cte_set_cte_ant_switch_delay_rx_aod_1us_2m
 *
...
void ble_bb_cte_set_cte_ant_switch_delay_rx_aod_1us_2m(int param_1)

{
  _DAT_600a2158 = _DAT_600a2158 & 0xffffff | param_1 << 0x18;
  return;
}
