 ...
 * Source: libbtbb -> bt_cte.o -> ble_bb_cte_set_fstep_cte_en
 *
...
void ble_bb_cte_set_fstep_cte_en(uint param_1)

{
  _DAT_600a215c = (param_1 & 0x800) << 0xb | _DAT_600a215c & 0xffbfffff;
  return;
}
