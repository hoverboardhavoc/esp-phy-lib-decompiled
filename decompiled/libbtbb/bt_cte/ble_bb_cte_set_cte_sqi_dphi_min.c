 ...
 * Source: libbtbb -> bt_cte.o -> ble_bb_cte_set_cte_sqi_dphi_min
 *
...
void ble_bb_cte_set_cte_sqi_dphi_min(int param_1)

{
  _DAT_600a2168 = _DAT_600a2168 & 0xffffff | param_1 << 0x18;
  return;
}
