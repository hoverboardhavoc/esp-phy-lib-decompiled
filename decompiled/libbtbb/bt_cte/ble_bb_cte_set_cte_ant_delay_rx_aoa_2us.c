 ...
 * Source: libbtbb -> bt_cte.o -> ble_bb_cte_set_cte_ant_delay_rx_aoa_2us
 *
...
void ble_bb_cte_set_cte_ant_delay_rx_aoa_2us(uint param_1)

{
  _DAT_600a2128 = _DAT_600a2128 & 0xffffff00 | param_1 & 0xff;
  return;
}
