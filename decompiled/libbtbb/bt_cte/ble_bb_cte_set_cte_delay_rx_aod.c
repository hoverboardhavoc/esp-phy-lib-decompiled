 ...
 * Source: libbtbb -> bt_cte.o -> ble_bb_cte_set_cte_delay_rx_aod
 *
...
void ble_bb_cte_set_cte_delay_rx_aod(uint param_1)

{
  _DAT_600a2124 = (param_1 & 0xff) << 10 | _DAT_600a2124 & 0xfffc03ff;
  return;
}
