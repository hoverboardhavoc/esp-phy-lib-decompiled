 ...
 * Source: libbtbb -> bt_cte.o -> ble_bb_cte_get_cte_ant_switch_delay_rx_aod_2us
 *
...
uint ble_bb_cte_get_cte_ant_switch_delay_rx_aod_2us(void)

{
  return _DAT_600a212c >> 0x10 & 0xff;
}
