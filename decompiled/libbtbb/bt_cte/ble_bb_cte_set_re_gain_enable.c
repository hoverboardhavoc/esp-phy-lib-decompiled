 ...
 * Source: libbtbb -> bt_cte.o -> ble_bb_cte_set_re_gain_enable
 *
...
void ble_bb_cte_set_re_gain_enable(uint param_1)

{
  _DAT_600a2820 = (param_1 & 1) << 1 | _DAT_600a2820 & 0xfffffffd;
  return;
}
