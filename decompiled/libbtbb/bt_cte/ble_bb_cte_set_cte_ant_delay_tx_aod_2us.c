 ...
 * Source: libbtbb -> bt_cte.o -> ble_bb_cte_set_cte_ant_delay_tx_aod_2us
 *
...
void ble_bb_cte_set_cte_ant_delay_tx_aod_2us(uint param_1)

{
  _DAT_600a2128 = (param_1 & 0xff) << 0x10 | _DAT_600a2128 & 0xff00ffff;
  return;
}
