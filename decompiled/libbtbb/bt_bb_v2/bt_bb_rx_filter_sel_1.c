 ...
 * Source: libbtbb -> bt_bb_v2.o -> bt_bb_rx_filter_sel_1
 *
...
void bt_bb_rx_filter_sel_1(void)

{
  _DAT_600460fc = _DAT_600460fc & 0xfe007fff | 0x200000;
  _DAT_6004604c = _DAT_6004604c & 0xffffffbf;
  return;
}
