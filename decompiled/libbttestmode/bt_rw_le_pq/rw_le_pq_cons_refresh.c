 ...
 * Source: libbttestmode -> bt_rw_le_pq.o -> rw_le_pq_cons_refresh
 *
...
void rw_le_pq_cons_refresh(uint *param_1,int *param_2)

{
  ...
  if (iVar1 != 0) {
    if ((_DAT_3fcd02c0 >> 0x10 & 0xff) == 0) {
      *param_2 = *param_2 + 1;
      if (2000 < (uint)(_DAT_60035000 - ate_rxsuc_time)) {
        ate_slave_time = _DAT_60035000 - ate_event_time;
      }
      ate_rxsuc_time = _DAT_60035000;
    }
