...

{
  ...
  DAT_00012de4 = DAT_00012de4 & 0xffff80ff | (param_2 & 0x7f) << 8;
  DAT_00012df0 = 0x2aa;
  _DAT_20101078 = _DAT_20101078 & 0xfff00000 | 0x4b73;
  devTable = bb_init_device(&timeline_table);
  ...
  phy_printf("power=%d\n",param_6);
  iVar2 = devTable;
  *(uint *)(devTable + 0x10) = *(uint *)(devTable + 0x10) & 0x1fffffff | (param_7 & 7) << 0x1d;
  ...
  *(uint *)(iVar2 + 0x54) = *(uint *)(iVar2 + 0x54) & 0xdf0000ff | (in_stack_0000000c & 1) << 0x1d;
  ...
  DAT_00013e6c = DAT_00013e6c & 0xfff00000 | 0x4faa;
  DAT_00013e70 = DAT_00013e70 & 0xfff00000 | 0x4bb2;
  uVar4 = DAT_00013e74 & 0xffffc000;
  DAT_00013e74._0_3_ = (uint3)uVar4 | in_stack_00000000 & 0x3fff;
  txLink0 = &tx_buflink;
  tx_buflink = tx_buflink & 0xeff00000 | (in_stack_00000008 & 1) << 0x1c;
  DAT_00013e74 = CONCAT13((char)(uVar4 >> 0x18),(uint3)DAT_00013e74) & 0x3fffffff;
