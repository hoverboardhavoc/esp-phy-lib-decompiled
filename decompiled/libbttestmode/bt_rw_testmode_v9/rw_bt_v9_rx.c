...
_L178:
  ...
  rw_bt_v9_prep_cs(0x3fcd0200,3,0,1,1,1,0,0);
  ...
  rw_init_tx_descriptor(&DAT_3fcd0300,&DAT_3fcd0320,0,0,1,uVar6,2,uVar7);
  rw_init_tx_descriptor(&DAT_3fcd0320,&DAT_3fcd0300,0,0,1,uVar6,2,uVar7);
  _DAT_60031418 = _DAT_60031418 | 0x20;
  iVar3 = rw_bt_v9_get_clkn();
  rw_bt_v9_set_rawstp_et(0x3fcd0100,iVar3 + 2U & 0xfffffff);
