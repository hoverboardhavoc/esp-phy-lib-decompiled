 ...
 * Source: libbttestmode -> bt_rw_le_testmode_v9.o -> rw_le_v9_prep_et
 *
...
void rw_le_v9_prep_et(uint *param_1,uint param_2,uint param_3,uint param_4,uint param_5,uint param_6
