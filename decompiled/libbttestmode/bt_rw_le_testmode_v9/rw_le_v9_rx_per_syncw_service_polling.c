...

{
  ...
  if (_DAT_3ffd02c0 << 0x10 < 0) {
    rw_le_v9_rxstat_unpack_adv
              (&DAT_3ffd02c0,&uStack_48,&iStack_3c,aiStack_38,aiStack_38 + 1,&uStack_24,&iStack_44,
               aiStack_38 + 3);
    rw_le_v9_set_rxundone(&DAT_3ffd02c0);
    rw_le_v9_rx_phyinfo(&DAT_3ffd02c0,0x3ffd0b00,&uStack_20,&uStack_1c,&uStack_18,aiStack_14);
    if (iStack_40 == 0) {
      if (aiStack_38[2] == 0) {
        if (aiStack_38[3] != 0) {
...
_L158:
  ...
  if (-1 < _DAT_3ffd02e0 << 0x10) {
    return;
  }
  rw_le_v9_rxstat_unpack_adv
            (&DAT_3ffd02e0,&uStack_48,&iStack_3c,aiStack_38,aiStack_38 + 1,&uStack_24,&iStack_44,
             aiStack_38 + 3);
  rw_le_v9_set_rxundone(&DAT_3ffd02e0);
  rw_le_v9_rx_phyinfo(&DAT_3ffd02e0,0x3ffd0f00,&uStack_20,&uStack_1c,&uStack_18,aiStack_14);
  if (iStack_40 != 0) {
    return;
  }
  if (aiStack_38[2] == 0) {
